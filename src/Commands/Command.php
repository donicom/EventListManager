...
use Donicom\EventlistManager\Models\LastInputCommandDB as ModelsLastInputCommandDB;
...
use Longman\TelegramBot\LastInputCommandDB;
...
abstract class Command
{
    ...
    */
    ...
    public function deletLastInputCommand() {
        $message = $this->getMessage();
        $chat_id = $message->getChat()->getId();
        // ModelsLastInputCommandDB::deleteLIC($chat_id);
    }
}
